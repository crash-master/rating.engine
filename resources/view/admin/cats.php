...
<div class="container">
	<div class="page" id="cats">
		<div class="jumbotron">
		  <h1 class="display-4">Категории <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#create-new-cat">Добавить</button></h1>
							...
							<tbody>
								<?php foreach ($cat_list as $key => $item): ?>
									<tr>
										...
										<td>
											<a class="danger-link" href="<?= linkTo('CatsController@remove', ['id' => $item['id']]) ?>">
