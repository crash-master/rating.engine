...
<div class="container">
	<div class="page" id="meta">
		<h1 class="page-name"><?= isset($page) ? 'Редактирование' : 'Создание' ?> страницы</h1>
		<div class="row">
			<div class="col-12">
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-8" style="text-align: right">
								<input type="checkbox" id="is_text" name="is_text" <?= (isset($page) and $page['is_text'] == '1') ? 'checked' : '' ?>>
								<label for="is_text">Текстовая страница</label>
							</div>
						</div>
