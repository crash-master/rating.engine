  <div id="top-carousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-control-btns">
      <button class="std-btn white carousel-prev" href="#top-carousel" role="button" data-slide="prev"><i class="m-icon arrow-left"></i></button>
      <button class="std-btn white carousel-next" href="#top-carousel" role="button" data-slide="next"><i class="m-icon arrow-right"></i></button>
    </div>
  </div>