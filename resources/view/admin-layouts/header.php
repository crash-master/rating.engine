...
<aside id="aside">
	...
	<nav class="main">
		<ul>
			...
			<? if(re_is_visible(linkTo('MediaController@admin_page'))): ?><li><a href="<?= linkTo('MediaController@admin_page', ['page_num' => 1]) ?>"><i class="fa fa-picture-o" aria-hidden="true"></i> Изображения</a></li><? endif; ?>
